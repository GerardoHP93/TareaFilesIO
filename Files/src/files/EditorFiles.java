...
public class EditorFiles extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGuardar.setFont(new java.awt.Font("Modern No. 20", 1, 14)); // NOI18N
        ...
        btnEliminar.setFont(new java.awt.Font("Modern No. 20", 1, 14)); // NOI18N
        ...
        btnArchivo.setFont(new java.awt.Font("Modern No. 20", 1, 14)); // NOI18N
        btnArchivo.setForeground(new java.awt.Color(102, 0, 0));
        ...
        cmboxTipoArchivo.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        cmboxTipoArchivo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "txt", "json", " " }));

        txtSeleccionar.setEditable(false);
        txtSeleccionar.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditorFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditorFiles().setVisible(true);
            }
        });
    }
